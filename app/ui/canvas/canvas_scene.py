...
class CanvasScene(QGraphicsScene):
    ...
    # ---------------------------------------------------------------- helpers
    def _create_item_for_block(self, block: BlockInstance) -> BlockItem:
        title = self._block_catalog.get(block.type_id, block.type_id)
        item = BlockItem(block, title=title, grid_size=self._grid_size)
        self.addItem(item)
